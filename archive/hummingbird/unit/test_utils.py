...
class TestDescriptionFilterText(unittest.TestCase):
    def setUp(self) -> None:
        ...
        with open(
            ...
            self.soup_p_and_table = BeautifulSoup(
                description_p_and_table, "html.parser"
            )
    ...
    def test_filter_includes_p_tags(self):
        ...
        filtered_p_tags = [
            p
            for p in self.soup_p_and_table.find_all(description_filter_text)
            if p.name == "p"
        ]
    ...
    def test_filter_does_not_include_img_tags(self):
        ...
        image_tags = [
            ...
            if (tag.child and tag.child.name == "img") or tag.name == "img"
        ]
